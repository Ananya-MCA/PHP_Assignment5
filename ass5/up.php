...
include 'con_db.php';
    ...
    {
        $pno  =$_POST['passno'];
        $q =mysqli_query($con, "select * from table1 WHERE pass_no = $pno ");
...
$sql = mysqli_query($con,"UPDATE `table1` set `pass_no`='$passno',`fname`='$fname',`mname`='$mname',`lname`='$lname',`dob`='$dob',`nationality`='$nation',`address`='$addr',`gender`='$gender',`pic`='$fstore' WHERE pass_no='$pno'");
if($sql)
                    {
